...
function iniciarJogo(){
    ...
    if(direction == "left") snakeX -= box;// direita aumenta, esquerda diminui pois trabalhamos com plano cartesiano
    if(direction == "up") snakeY -= box;
    if(direction == "down") snakeY += box;//Diminui para cima, aumenta para baixo, pela mesma lógica
